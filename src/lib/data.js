...
`     ],
      ...
      description: \`Utilizes multiple Twitch APIs to analyze the chat in broadcast replays to generate highlights based on emote usage. 
        Checking for sudden peaks in emote use, timestamps are generated and provided to the frontend, allowing the user to sort highlights 
        by emote and the top 10 peaks of said emote's use. Generated data is stored via MongoDB for future users looking for highlights from 
        the same broadcast.\`,
